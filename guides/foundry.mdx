...
| Code Review | `gpt-5.1` | 0.2 | low | Precise, technical feedback |
...
:::tip
Create a "Cost Saver" mode with a cheap model like `claude-3-haiku` or `gpt-4.1-nano` for simple tasks, and a "Heavy Lifting" mode with a powerful model for complex work. Switch between them with `/mode` to manage costs.
:::
