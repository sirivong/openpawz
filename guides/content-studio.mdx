...
:::tip
AI Improve uses your currently configured model and provider. For best results with long-form content, use a capable model like Claude Sonnet or GPT-5.1.
:::
