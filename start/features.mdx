...
<Columns cols={2}>
  ...
  <Card title="Per-agent model override">
    Each agent can use a different AI model, overriding the global default. Run your research agent on Claude, your coder on GPT-5.1, and your assistant on a local Ollama model — simultaneously.
  </Card>
...
| OpenAI | Cloud | GPT-5.1, GPT-4.1, o3, o4-mini |
